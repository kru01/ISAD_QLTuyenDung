    ...
    internal class PTTDangTuyenDB
    {
        ...
        public static string? ThemPhieu(PTTDangTuyen phieu, OracleConnection conn)
        {
            try
            {
                ...
                cmd.Parameters.Add("ISOLUONGTD", OracleDbType.Int64, 255).Value = phieu.soLuong;
                ...
                cmd.Parameters.Add("IYEUCAUUV", OracleDbType.Varchar2, 255).Value = phieu.yeuCau;
                cmd.Parameters.Add("ITONGTIEN", OracleDbType.Int64, 255).Value = phieu.tongTien;
                cmd.Parameters.Add("IHTTHANHTOAN", OracleDbType.Int64, 255).Value = phieu.hinhThuc;
                cmd.Parameters.Add("INVLAP", OracleDbType.Varchar2, 255).Value = phieu.curUser;
