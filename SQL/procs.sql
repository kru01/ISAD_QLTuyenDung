...
CREATE OR REPLACE PROCEDURE USP_PDKQUANGCAO_INS(
    ...
    INSERT INTO PDKQUANGCAO VALUES (IMADN, IMAPHIEU, IMAHT, CNGAYBD,
        TO_DATE(INGAYKT, 'DD/MM/YYYY'));
END;
/
...
BEGIN SAVEPOINT SVP_CTHOADON_INS;
    ...
    IMACT := IMACT + 1;
    INSERT INTO CTHOADON VALUES (IMADN, IMAPHIEU, IMACT, ISOTIEN,
        CNGAYTRA, IPTTHANHTOAN);
