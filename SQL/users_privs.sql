...
GRANT SELECT, INSERT, UPDATE ON HOSOUNGTUYEN TO RL_N3QLTD_NV;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON DNTIEMNANG TO RL_N3QLTD_LD;
GRANT SELECT, INSERT, UPDATE ON CHIENLUOCUUDAI TO RL_N3QLTD_LD;